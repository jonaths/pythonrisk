...
class QLearning:
    ...
    def setQCell(self,state_index, action_index, qvalue):
        if self.Q.shape[0] > state_index >= 0:
            print "WARNING: Q cell", state_index, action_index, "set manually to", qvalue
            self.Q[state_index, action_index] = qvalue
            print self.Q
